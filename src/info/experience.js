export const experience = [
  {
    ...
    tech:
      "Technologies: React/Redux, SWR, Rest Hooks, Material-UI, Formik, Django, DjangoRestFramework, Celery, jFrog, HTML, CSS, SQL",
    description: [
  ...
  },
  {
    ...
    tech:
      "Technologies: React/Redux, Material-UI, HTML, CSS, Sass,TypeScript & NodeJS",
    description: [
